...
if(NOT TARGET Ext_NeighborhoodSearch)
	if(USE_GPU_NEIGHBORHOOD_SEARCH)
		...
		ExternalProject_Add(
		   ...
		   CMAKE_ARGS -DCMAKE_BUILD_TYPE=${EXT_CMAKE_BUILD_TYPE} -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS} -DCMAKE_CXX_FLAGS_RELEASE=${CMAKE_CXX_FLAGS_RELEASE} -DCMAKE_INSTALL_PREFIX:PATH=${ExternalInstallDir}/NeighborhoodSearch -DCUNSEARCH_USE_DOUBLE_PRECISION:BOOL=${USE_DOUBLE_PRECISION} -DBUILD_DEMO:BOOL=OFF -DCMAKE_CXX_STANDARD:STRING=17 -DCMAKE_CUDA_STANDARD:STRING=17 -DCMAKE_CUDA_FLAGS:STRING=-DCCCL_IGNORE_DEPRECATED_CPP_DIALECT
		   )
